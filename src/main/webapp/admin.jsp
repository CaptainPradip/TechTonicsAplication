...
<br>
  ...
  <table class="table table-striped">
                                ...
                                <tbody>
                                  ...
                                  <%
                                   List<TechTalk> tech= (List<TechTalk>)session.getAttribute("techtalklist");
                                          ...
                                          <td><% out.print(techTalk.getTitle()); %> </td>
                                            <td><% out.print(techTalk.getSpeaker()) ;%> </td>
                                              <td><% out.print(techTalk.getDescription()); %> </td>
                                                <td><a href="action?id=<%= techTalk.getTechid()%>&action=update">Update</a></td>
                  			           <td><a href="action?id=<%= techTalk.getTechid()%>&action=delete">Delete</a></td>
                  			            <td><a href="action?id=<%= techTalk.getTechid()%>&action=registers">Registers</a></td>
                  			       </tr>
                  			      <% } %>	
