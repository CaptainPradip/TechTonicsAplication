    ...
    <div id="signupbox" style=" margin-top:50px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
        <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title">Add TechTalk</div>
                    ...
                    <form  class="form-horizontal" method="POST" action="action" >
                        ...
                        <div id="div_id_username" class="form-group required">
                            ...
                            <div class="controls col-md-6 ">
                                <input value="" class="input-md  textinput textInput form-control" id="id_username" maxlength="30" name="id"  style="margin-bottom: 10px" type="text" />
                            </div>
                        </div>
                        <div id="div_id_email" class="form-group required">
                            <label for="id_email" class="control-label col-md-4  requiredField">Venue<span class="asteriskField">*</span> </label>
                            <div class="controls col-md-6 ">
                                <input value="" class="input-md emailinput form-control" id="id_email" name="venue" style="margin-bottom: 10px" type="text" />
                            </div>     
                        </div>
                        <div id="div_id_password1" class="form-group required">
                            <label for="id_password1" class="control-label col-md-4  requiredField">Speaker<span class="asteriskField">*</span> </label>
                            <div class="controls col-md-6 "> 
                                <input value="" class="input-md textinput textInput form-control"  name="speaker" style="margin-bottom: 10px" type="text" />
                            </div>
                        </div>
                        <div id="div_id_password2" class="form-group required">
                             <label for="id_password2" class="control-label col-md-4  requiredField">Date<span class="asteriskField">*</span> </label>
                             <div class="controls col-md-6 ">
                                <input value=""class="input-md textinput textInput form-control"  name="date" style="margin-bottom: 10px" type="date" />
                            </div>
                        </div>
                        <div id="div_id_name" class="form-group required"> 
                            <label for="id_name" class="control-label col-md-4  requiredField">Time<span class="asteriskField">*</span> </label> 
                            <div class="controls col-md-6 "> 
                                <input value=""class="input-md  textInput form-control"  name="time"  style="margin-bottom: 10px" type="time" />
                            </div>
                        </div>
                        ...
                        <div id="div_id_company" class="form-group required"> 
                            ...
                            <div class="controls col-md-6 "> 
                                 <input value="" class="input-md textinput textInput form-control"  name="title"  style="margin-bottom: 10px" type="text" />
                            </div>
                        </div> 
                        <div id="div_id_catagory" class="form-group required">
                            ...
                            <div class="controls col-md-6 "> 
                                 <input  value=""class="input-md textinput textInput form-control" name="Description" style="margin-bottom: 10px" type="text" />
                            </div>
                        </div> 
                        ...
                        <div class="form-group"> 
                            ...
                            <div class="controls col-md-4 ">
                                <input type="submit" name="action" value="add" class="btn btn-primary btn btn-info" id="submit-id-signup" />
